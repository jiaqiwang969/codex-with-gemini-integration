...
| Action                                     | Command                                  |
| ------------------------------------------ | ---------------------------------------- |
| Run a command in a specific package        | `pnpm --filter @jiaqiwang969/codex run build`  |
| Install a dependency in a specific package | `pnpm --filter @jiaqiwang969/codex add lodash` |
