...
static PRESETS: Lazy<Vec<ModelPreset>> = Lazy::new(|| {
    vec![
        ...
        ModelPreset {
            ...
            display_name: "gemini-3-pro-preview-thinking",
            description: "Google Gemini 3 Pro preview with thinking capability.",
            default_reasoning_effort: ReasoningEffort::Medium,
            supported_reasoning_efforts: &[ReasoningEffortPreset {
                effort: ReasoningEffort::Medium,
                description: "Default Gemini reasoning behaviour.",
        ...
        ModelPreset {
            id: "gemini-3-pro-preview-thinking-codex",
            model: "gemini-3-pro-preview-thinking-codex",
            display_name: "gemini-3-pro-preview-thinking-codex",
        ...
        ModelPreset {
            id: "gemini-3-pro-preview-thinking-germini",
            model: "gemini-3-pro-preview-thinking-germini",
            display_name: "gemini-3-pro-preview-thinking-germini",
            description: "Gemini 3 Pro preview with thinking capability and Germini-style system prompt.",
            default_reasoning_effort: ReasoningEffort::Medium,
            supported_reasoning_efforts: &[ReasoningEffortPreset {
                effort: ReasoningEffort::Medium,
