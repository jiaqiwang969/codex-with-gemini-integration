...
impl ChatWidget {
    ...
    pub(crate) fn on_rate_limit_snapshot(&mut self, snapshot: Option<RateLimitSnapshot>) {
        if let Some(mut snapshot) = snapshot {
            ...
            if high_usage
                ...
                && self.model_family.slug != NUDGE_MODEL_SLUG
                && !matches!(
    ...
    pub(crate) fn new(
        ...
        let model_slug = model_family.slug.clone();
    ...
    pub(crate) fn open_model_popup(&mut self) {
        let current_model = self.model_family.slug.clone();
    ...
    pub(crate) fn open_reasoning_popup(&mut self, preset: ModelPreset) {
        ...
        let is_current_model = self.model_family.slug == preset.model;
